...
<div class="container mt-4">
    <?= form_open("coadmin/createStudent", ['class' => 'form-horizontal']);?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <?= form_input(['name' => 'namasiswa', 'class'=> 'form-control','placeholder'=>'Masukkan Nama Mahasiswa', 'value'=>set_value('namasiswa')]);?>
...
<!-- __________________________________________________________________________________________________________________________________________________________________________________________________________________________________________ -->
    ...
    <?= anchor("coadmin/dashboard","BATAL", ['class'=> 'btn btn-warning my-4']);?>
</div>
<?=form_close(); ?>
</div>
